...
- Average retrieval latency: **1157.7 ms**
...
| G08 | long_term | PASS | 1948.1 | 839 | 0.0% |  |
| G09 | long_term | PASS | 1510.7 | 1621 | 0.0% |  |
| G12 | semantic | PASS | 295.5 | 418 | 8.9% |  |
| G14 | semantic | PASS | 318.0 | 270 | 30.2% |  |
| G15 | semantic | PASS | 264.3 | 270 | 41.2% |  |
| G19 | mixed | PASS | 2173.8 | 581 | 0.0% |  |
| G03 | long_term | PASS | 1704.3 | 1628 | 0.0% |  |
| G04 | long_term | PASS | 1722.0 | 1602 | 0.0% |  |
| G05 | long_term | PASS | 1703.8 | 1612 | 0.0% |  |
| G10 | episodic | PASS | 567.6 | 309 | 0.0% |  |
| G11 | episodic | PASS | 510.6 | 309 | 0.0% |  |
| G13 | semantic | PASS | 256.4 | 416 | 26.4% |  |
| G16 | mixed | PASS | 2058.1 | 581 | 0.0% |  |
| G18 | mixed | PASS | 550.4 | 500 | 11.5% |  |
| G20 | mixed | PASS | 2229.4 | 831 | 0.0% |  |
| G06 | long_term | PASS | 1726.8 | 1613 | 0.0% |  |
| G07 | long_term | PASS | 1563.5 | 1616 | 0.0% |  |
| G17 | mixed | PASS | 2049.8 | 581 | 8.1% |  |
...
`<USER_SUMMARY> The user's personal project is named ORCHID-27, for which they prefer Python. For the company project BLUEBIRD-42, the backend must use TypeScript with NestJS, and Python is not permitted for this project.  Minh Nguyen likes Python and dislikes Java. When explaining code, use short examples. The user is learning async/await and sometimes confuses coroutines with Tasks. If this topic arises later, explain it using a timeline.  The AI will prioritize timelines when explaining coroutines and Tasks. </USER_SUMMARY>  <EPISODES> Episodes are source message or document excerpts shown in selection order.   - Created At: 2026-08-17 05:22:43     Source: message     Content: [user] {   "`
...
`<USER_SUMMARY> The user's personal project is named ORCHID-27, for which they prefer Python. For the company project BLUEBIRD-42, the backend must use TypeScript with NestJS, and Python is not permitted for this project.  Minh Nguyen likes Python and dislikes Java. When explaining code, use short examples. The user is learning async/await and sometimes confuses coroutines with Tasks. If this topic arises later, explain it using a timeline.  The AI will prioritize timelines when explaining coroutines and Tasks. </USER_SUMMARY>  <EPISODES> Episodes are source message or document excerpts shown in selection order.   - Created At: 2026-08-17 05:22:38     Source: message     Content: [user] {   "`

### G04 - long_term

`<USER_SUMMARY> The user's personal project is named ORCHID-27, for which they prefer Python. For the company project BLUEBIRD-42, the backend must use TypeScript with NestJS, and Python is not permitted for this project.  Minh Nguyen likes Python and dislikes Java. When explaining code, use short examples. The user is learning async/await and sometimes confuses coroutines with Tasks. If this topic arises later, explain it using a timeline.  The AI will prioritize timelines when explaining coroutines and Tasks. </USER_SUMMARY>  <EPISODES> Episodes are source message or document excerpts shown in selection order.   - Created At: 2026-08-17 05:22:36     Source: message     Content: [user] {   "`
...
`<USER_SUMMARY> The user's personal project is named ORCHID-27, for which they prefer Python. For the company project BLUEBIRD-42, the backend must use TypeScript with NestJS, and Python is not permitted for this project.  Minh Nguyen likes Python and dislikes Java. When explaining code, use short examples. The user is learning async/await and sometimes confuses coroutines with Tasks. If this topic arises later, explain it using a timeline.  The AI will prioritize timelines when explaining coroutines and Tasks. </USER_SUMMARY>  <EPISODES> Episodes are source message or document excerpts shown in selection order.   - Created At: 2026-08-17 05:22:46     Source: message     Content: [user] {   "`

### G07 - long_term

`<USER_SUMMARY> The user's personal project is named ORCHID-27, for which they prefer Python. For the company project BLUEBIRD-42, the backend must use TypeScript with NestJS, and Python is not permitted for this project.  Minh Nguyen likes Python and dislikes Java. When explaining code, use short examples. The user is learning async/await and sometimes confuses coroutines with Tasks. If this topic arises later, explain it using a timeline.  The AI will prioritize timelines when explaining coroutines and Tasks. </USER_SUMMARY>  <EPISODES> Episodes are source message or document excerpts shown in selection order.   - Created At: 2026-08-17 05:25:55     Source: message     Content: [user] {   "`
